namespace Ordering.Infrastructure.Data.Extensions
{
    public class InitialData
    {
        public static IEnumerable<Customer> Customers =>
            new List<Customer>
            {
               Customer.Create(CustomerId.Of(new Guid("58c49479-ec65-4de2-86e7-033c546291aa")), "akher", "akher.ice07@gmail.com"),
        ...
        public static IEnumerable<Order> OrdersWithItems
        {
            get
            {
                var address1 = Address.Of("akher", "ussaman", "akher.ice07@gmail.com", "Bahcelievler No:4", "Turkey", "Istanbul", "38050");
